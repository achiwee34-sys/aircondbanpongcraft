...
(function() {
  const DEFAULT_USERS = [
    {id:'u1',name:'ผู้ดูแลระบบ',username:'admin',password:'sha256:240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9',role:'admin',dept:'IT',tel:'',contact:''},
    {id:'u6',name:'นายสมหมาย ผู้จัดการ',username:'manager',password:'sha256:0e1a137623819274b1ec55c7354c00c949f54d03653f698e2ce4e1e93de726cc',role:'executive',dept:'ฝ่ายบริหาร',tel:'',contact:''},
  ];
...
function initDB() {
  return {
    users: [
      ...
      // admin123  → sha256 (pre-hashed ตั้งแต่ hardcode)
      // exec123   → sha256 (pre-hashed ตั้งแต่ hardcode)
      {id:'u1',name:'ผู้ดูแลระบบ',username:'admin',password:'sha256:240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9',role:'admin',dept:'IT',tel:'',contact:''},
      {id:'u6',name:'นายสมหมาย ผู้จัดการ',username:'manager',password:'sha256:0e1a137623819274b1ec55c7354c00c949f54d03653f698e2ce4e1e93de726cc',role:'executive',dept:'ฝ่ายบริหาร',tel:'',contact:''},
    ],
    machines: [
...
async function doLogin() {
  ...
  try {
    ...
    CU = candidate;
    const sessionData = { uid: candidate.id, uname: candidate.username, exp: Date.now() + 14*24*60*60*1000 };
